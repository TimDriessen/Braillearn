...
#Quiz content
quiz = ['day', 'ever', 'father', 'here', 'know', 'lord', 'mother', 'name', 'one', 'part', 'question', 'right', 'some', 'time', 'under', 'work', 'young', 'there', 'character', 'through', 'where', 'ought', 'upon', 'word', 'these', 'those', 'whose', 'cannot', 'many', 'spirit', 'world', 'their']
