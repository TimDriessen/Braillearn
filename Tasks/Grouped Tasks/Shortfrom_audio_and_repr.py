...
#Quiz content
quiz = ['about', 'above', 'according', 'across', 'after', 'afternoon', 'afterward', 'again', 'against', 'almost', 'already', 'also', 'although', 'altogether', 'always', 'because', 'before', 'behind', 'below', 'beneath', 'beside', between', 'beyond', 'blind', 'braille', 'children', 'conceive', 'conceiving', 'could', 'deceive', 'declare', 'either', 'first', 'friend', 'good', 'great', 'herself', 'him', 'himself', 'immediate', 'its', 'itself', 'letter', 'little', 'much', 'myself', 'must', 'necessary', 'neither', 'oneself', 'ourselves', 'paid', 'perceive', 'perhaps', 'quick', 'receiving', 'rejoice', rejoicing', 'said', 'should', 'thyself', 'today', 'together', 'tomorrow', 'tonight', 'would', 'your', 'yourself', 'yourselves']
